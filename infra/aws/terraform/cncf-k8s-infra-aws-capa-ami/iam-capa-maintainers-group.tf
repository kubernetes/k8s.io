...
resource "aws_iam_group_policy_attachment" "maintainer-ec2" {
  group      = aws_iam_group.maintainers.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2FullAccess"
}

resource "aws_iam_group_policy_attachment" "maintainer-s3" {
  group      = aws_iam_group.maintainers.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonS3FullAccess"
}

resource "aws_iam_group_policy_attachment" "maintainer-cloudtrail" {
  group      = aws_iam_group.maintainers.name
