...
resource "aws_servicequotas_service_quota" "events_rules" {
...
resource "aws_servicequotas_service_quota" "vpc_max_vpcs" {
...
resource "aws_servicequotas_service_quota" "vpc_max_nat_gateways" {
...
resource "aws_servicequotas_service_quota" "vpc_max_internet_gateways" {
...
resource "aws_servicequotas_service_quota" "ec2_max_elastic_ips" {
...
resource "aws_servicequotas_service_quota" "ec2_max_vcpus" {
...
resource "aws_servicequotas_service_quota" "ec2_max_vcpus_g_vt" {
