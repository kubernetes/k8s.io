...
module "us-east-2" {
  ...
  s3_replication_iam_role_arn = "arn:aws:iam::513428760722:role/artifacts.k8s.io_s3writer"

  s3_replication_rules = [
    {
      id                               = "artifacts-k8s-io-us-east-2-to-artifacts-k8s-io-us-west-2"
      status                           = "Enabled"
      priority                         = 2
      destination_bucket_arn           = "arn:aws:s3:::${var.prefix}artifacts-k8s-io-us-west-2"
